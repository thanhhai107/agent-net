...
def visualize_command(
    session_id: str | None = typer.Option(
        None, "--session-id", help="Open this session initially; defaults to the newest session."
    ),
    ...
    if not available_ids:
        raise typer.BadParameter("No sessions found. Run `nika env run <scenario>` first.")
