...
\item \textbf{Đề xuất và hiện thực hóa mô-đun Tool Refinement:} Thiết kế cơ chế cho phép AI Agent tự tinh chỉnh mô tả của các công cụ MCP nguyên thủy thông qua vòng lặp Explorer--Analyzer--Rewriter lấy cảm hứng từ DRAFT. Tài liệu tinh chỉnh được gắn động vào mô tả công cụ tại thời điểm thực thi, giúp LLM sử dụng công cụ chính xác và hiệu quả hơn theo thời gian. Cơ chế đóng băng adaptive đảm bảo dừng tinh chỉnh khi tài liệu hội tụ.
    ...
    \item \textbf{Công bố mã nguồn:} Mã nguồn hệ thống, cấu hình chạy và các thành phần thực nghiệm được đặt tại repository GitHub \href{https://github.com/thanhhai107/agent-net}{thanhhai107/agent-net}.
