...
class CodexCliAgentPipelineTest(CommonPipelineSteps, OrderedPipelineTestCase):
    ...
    def test_step_04_check_workspace_and_messages(self) -> None:
        ...
        self.assertIn("NIKA-Session-Id", config_text)
...
@unittest.skipUnless(
    ...
    "containerlab/gnmic/Docker or Codex CLI credentials not available",
)
class CodexClabPipelineTest(ClabCommonPipelineSteps, OrderedPipelineTestCase):
    ...
    def test_step_04_check_workspace_and_messages(self) -> None:
        ...
        self.assertIn("NIKA-Session-Id", config_text)
        self.assertIn(self.session_id, config_text)
        self.assertIn("[mcp_servers.kathara_base_mcp_server]", config_text)
        self.assertNotIn("[mcp_servers.kathara_frr_mcp_server]", config_text)
